...
cp ~/master_thesis_simulation_mgs/simulator_grid-connected_micro_grid/simulation_results/reliable_stage1_mgs/results_reliable_stage1_mgs.csv ~/user_shares/Martha.Hoffmann/Nigeria_results_sync

python3 A_main_script.py ./inputs/unreliable_stage1_mgs.xlsx
cp ~/master_thesis_simulation_mgs/simulator_grid-connected_micro_grid/simulation_results/unreliable_stage1_mgs/results_unreliable_stage1_mgs.csv ~/user_shares/Martha.Hoffmann/Nigeria_results_sync
