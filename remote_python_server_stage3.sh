...
python3 A_main_script.py ./inputs/reliable_stage3_mgs_s.xlsx
cp ./master_thesis_simulation_mgs/simulator_grid-connected_micro_grid/simulation_results/reliable_stage3_mgs_s/results_reliable_stage3_mgs_s.csv ~/user_shares/Martha.Hoffmann/Nigeria_results_sync
