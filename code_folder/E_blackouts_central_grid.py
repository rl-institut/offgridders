...
class central_grid:
    ...
    def get_blackouts(settings, blackout_experiment_s):
        ...
        if data_complete == False:
            ...
            grid_availability_df = central_grid.availability(
                settings,
    ...
    def availability(
        ...
        for experiment in blackout_experiment_s:
            ...
            number_of_blackouts = central_grid.number_of_blackouts(
            ...
            if number_of_blackouts != 0:
                time_of_blackout_events = central_grid.get_time_of_blackout_events(
                ...
                ) = central_grid.get_blackout_event_durations(
                ...
                ) = central_grid.availability_series(
                    grid_availability,
